    ...
    return (
        <div className="form">
            <div className="form__input">
                ...
                />
                <img 
                    className={classnames('form__image', {'form__image--loaded': !!logic.inputState.imageUrl})} 

...
import { CHANGE_INPUT, CLEAR_INPUT, ADDED_BOOK, REMOVE_BOOK, EDIT_BOOK } from '../types/bookShelf.types'
...
export const LogicBook = ({ children }) => {
    ...
    return (
        <LogicBookShelf.Provider value={{
            inputState, onChangeInput, onCancelAction, onAddNewBook,
            listBooks, onRemoveBook, onEditBook, onEditDoneBook
        }}>
            {children}
